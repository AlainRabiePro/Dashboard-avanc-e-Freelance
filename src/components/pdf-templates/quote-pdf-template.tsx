...
export function QuotePdfTemplate({ quote }: { quote: Quote }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '40px' }}>
        <h1 style={{ fontSize: '32px', margin: '0 0 30px 0', fontWeight: 'bold' }}>Quote</h1>
      </div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ marginBottom: '15px' }}>
            <p style={{ margin: '0 0 5px 0', fontWeight: 'bold', color: '#666' }}>Quote Number</p>
            <p style={{ margin: 0, fontSize: '18px', fontWeight: 'bold' }}>{quote.quoteNumber}</p>
          </div>
          <div>
            <p style={{ margin: '0 0 5px 0', fontWeight: 'bold', color: '#666' }}>Quoted To</p>
            <p style={{ margin: 0 }}>{quote.client}</p>
          </div>
        </div>
        <div style={{ textAlign: 'right' }}>
          <div style={{ marginBottom: '15px' }}>
            <p style={{ margin: '0 0 5px 0', fontWeight: 'bold', color: '#666' }}>Issue Date</p>
            <p style={{ margin: 0 }}>{formatDate(quote.issueDate)}</p>
          </div>
          <div>
            <p style={{ margin: '0 0 5px 0', fontWeight: 'bold', color: '#666' }}>Valid Until</p>
            <p style={{ margin: 0 }}>{formatDate(quote.validUntil)}</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: '40px' }}>
        ...
        <p style={{ margin: 0, fontSize: '16px', fontWeight: 'bold' }}>{quote.status}</p>
      </div>
